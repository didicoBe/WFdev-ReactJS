            ...
            <Navbar.Collapse className="justify-content-end">
                <Navbar.Text >
                    <a target="_blank" href="https://www.facebook.com/wfdesenvolvimento/">
                        <FontAwesomeIcon icon={faFacebook} color="white" fontSize="22px"  className="redesocial" />
                    </a> 
                    <a target="_blank" href="https://www.behance.net/didico">
                        <FontAwesomeIcon icon={faBehance} color="white" fontSize="22px"  className="redesocial" />
                    </a>                    
                    <a target="_blank" href="https://www.linkedin.com/in/waldir-bertuqui-neto/">
                        <FontAwesomeIcon icon={faLinkedin} color="white" fontSize="22px"  className="redesocial" />
                    </a>
                    <a target="_blank" href="https://github.com/didicoBe">
                        <FontAwesomeIcon icon={faGithub} color="white" fontSize="22px"  className="redesocial" />
                    </a>                    
                </Navbar.Text>
            </Navbar.Collapse>
